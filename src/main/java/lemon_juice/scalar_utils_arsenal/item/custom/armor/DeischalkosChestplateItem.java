...
public class DeischalkosChestplateItem extends DeischalkosArmorItem {
    public DeischalkosChestplateItem(ArmorMaterial material, EquipmentSlot slot, Properties properties) {
